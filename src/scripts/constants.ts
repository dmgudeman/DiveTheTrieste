...
export const MAP_POINT_OBJECTS: IMapPointObject[] = [  
  ...
  {'id':3,  'name':'START_BUMP',       'point': MP_3,   mvmtLat: 'left',  'coeff': [ -0.1823, -0.2618 ], "display": "Continental Shelf" }, 
  {'id':4,  'name':'BUMP_PEAK',        'point': MP_4,   mvmtLat: 'left',  'coeff': [ -0.2239, -0.2115 ], "display": "A little peak" },
  {'id':5,  'name':'END_BUMP',         'point': MP_5,   mvmtLat: 'right', 'coeff': [ -0.2552, -0.2618 ], "display": "Continental Shelf" },
  {'id':6,  'name':'START_DBL',        'point': MP_6,   mvmtLat: 'left',  'coeff': [ -0.2781, -0.2618 ], "display": "The double peak" },
  {'id':7,  'name':'DBL_PEAK_1',       'point': MP_7,   mvmtLat: 'left',  'coeff': [ -0.3021, -0.1108 ], "display": "The double peak" },
  {'id':8,  'name':'DBL_PEAK_2',       'point': MP_8,   mvmtLat: 'both',  'coeff': [ -0.3437, -0.1208 ], "display": "The double peak" },
  {'id':9,  'name':'END_DBL',          'point': MP_9,   mvmtLat: 'right', 'coeff': [ -0.3646, -0.2422 ], "display": "The double peak" },
  {'id':10, 'name':'START_TRENCH',     'point': MP_10,  mvmtLat: 'both',  'coeff': [ -0.4115, -0.2618 ], "display": "Continental Shelf" },
  {'id':11, 'name':'TRENCH_BOTTOM_L',  'point': MP_11,  mvmtLat: 'right', 'coeff': [ -0.4635, -0.8862 ], "display": "Starting" },
  {'id':12, 'name':'TRENCH_BOTTOM_R',  'point': MP_12,  mvmtLat: 'both',  'coeff': [ -0.4791, -0.8862 ], "display": "Starting" },
  {'id':13, 'name':'END_TRENCH',       'point': MP_13,  mvmtLat: 'left',  'coeff': [ -0.5312, -0.2618 ], "display": "Starting" },
  {'id':14, 'name':'END_POSITION',     'point': MP_14,  mvmtLat: 'both',  'coeff': [ -0.5729, -0.2618 ], "display": "Starting" },
  {'id':15, 'name':'OOB_RIGHT',        'point': MP_15,  mvmtLat: 'left',  'coeff': [ -1, -0.2618 ], "display": "Starting" },
  {'id':16, 'name':'OOB_RIGHT_2',      'point': MP_16,  mvmtLat: 'left',  'coeff': [ -1, -0.2618 ], "display": "Starting" },
]
