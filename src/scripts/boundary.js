...
//         console.log("COMPLATTTTT AT OCEAN LAT LIMIT", compLat);
//         if (compVert <= 0) {
//             ocean.velRight = LAT_VELOCITY;
//             ocean.velLeft = LAT_VELOCITY;
//             ocean.velUp = 0;
...
//         }
//     } else if (compLat > OCEAN_LAT_LIMIT) {
//       console.log("BOUNDARY OVER_LAT_LIMIT", compLat)
//         if (compVert <= 0) {
//             ocean.velRight = 0;
//             ocean.velLeft = 0
//             ocean.velUp = 0;
...
//     }
//     // reset extra check for out of bounds left
//     if (compLat < 0) {
//         ocean.sx = 0;
